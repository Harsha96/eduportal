    ...
    <section class="pt-40 pb-20 bg-white">
        <div class="max-w-7xl mx-auto px-6 lg:px-8">
            <nav class="flex mb-8 text-sm font-medium text-gray-400">
                ...
                <a href="technology-services.php" class="hover:text-primary">Technology Services</a>
                <span class="mx-2">/</span>
                <span class="text-primary">Digital Engineering</span>
            </nav>
            <div class="grid lg:grid-cols-2 gap-16 items-center">
                <div>
                    <h1 class="sora text-4xl lg:text-6xl font-black text-gray-900 mb-6 leading-tight">Modernizing the
