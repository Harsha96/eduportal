        ...
        const MasterData = {
            'ielts': {
                ...
                modalData: {
                    ...
                    packages: [
                        { name: 'IELTS Express', subType: '15 DAYS FAST TRACK', icon: 'zap', iconColor: 'blue-600', iconBg: 'blue-50', features: ['15 Hours Live Classes', '5 Full Mock Tests', 'Writing Eval included'], cta: 'https://unidemyglobal.com/login.php?url=IELTS-Express' },
                        { name: 'Band 7.5+ Booster', subType: 'COMPREHENSIVE TRAINING', highlight: 'MOST POPULAR', icon: 'crown', iconColor: 'orange-600', iconBg: 'orange-50', features: ['32 Hours Live classes', '10 Full Mock Tests', 'Unlimited Doubt clearing', 'Career Counseling'], cta: 'https://unidemyglobal.com/login.php?url=IELTS-Booster' },
                        { name: 'IELTS Masterclass', subType: '1-ON-1 PERSONALIZED', icon: 'users', iconColor: 'blue-600', iconBg: 'blue-50', features: ['Private 1-on-1 sessions', '15+ Full Mock Tests', 'Experts Master Trainers', 'Admission support'], cta: 'https://unidemyglobal.com/login.php?url=IELTS-Masterclass' }
                    ]
                }
            },
            'toefl': {
                ...
                modalData: {
                    ...
                    packages: [{ name: 'PowerScore Pro', subType: 'INTENSIVE TRAINING', icon: 'zap', iconColor: 'violet-600', iconBg: 'violet-50', highlight: 'RECOMMENDED', features: ['30+ Hours Live Training', '10+ Authentic Mock Tests', '25+ Writing Reviews', 'Speaking Feedback', 'Smart Analytics'], cta: 'https://unidemyglobal.com/login.php?url=TOEFL-PowerScore' }]
                }
            },
            'duolingo': {
                ...
                modalData: {
                    ...
                    packages: [{ name: 'DET Express', subType: '2-WEEK INTENSIVE', icon: 'bird', iconColor: 'emerald-600', iconBg: 'emerald-50', features: ['AI-powered feedback', 'Adaptive practice tests', 'Exam Simulations', 'Rapid Feedback'], cta: 'duolingo.php' }]
                }
            },
            'sat': {
                name: 'Digital SAT',
                ...
                modalData: {
                    ...
                    packages: [{ name: 'SAT Digital Elite', subType: 'FULL ACCESS', icon: 'graduation-cap', iconColor: 'blue-600', iconBg: 'blue-50', features: ['60+ Hours Live Prep', '2000+ Practice Questions', '15+ Full Mocks', 'Score Guarantee'], cta: 'sat.php' }]
                }
            },
            'act': {
                ...
                modalData: {
                    ...
                    packages: [{ name: 'ACT Mastery', subType: 'COMPLETE PREP', icon: 'target', iconColor: 'indigo-600', iconBg: 'indigo-50', features: ['Science Section Specialist', 'Timed Section Drills', 'Expert Strategy Guides', '4 Full Mocks'], cta: 'act.php' }]
                }
            },
            'gre': {
                name: 'GRE General',
                ...
                modalData: {
                    ...
                    packages: [{ name: 'Smart Score Elite', subType: 'STRATEGY FOCUSED', icon: 'brain-circuit', iconColor: 'orange-600', iconBg: 'orange-50', highlight: 'STRATEGY FOCUSED', features: ['Quant Shortcuts', 'Verbal Workshops', '10+ Adaptive Mocks', 'Vocab Booster', 'AWA Scored Reviews'], cta: 'https://unidemyglobal.com/login.php?url=GRE-Elite' }]
                }
            },
            'topik': {
                name: 'Korean (TOPIK)',
                ...
                modalData: {
                    ...
                    packages: [
                        { name: 'TOPIK I Mastery', subType: 'LEVEL 1-2', category: 'beginner', icon: 'book', iconColor: 'rose-600', iconBg: 'rose-50', features: ['Beginner survival Korean', 'Core grammar patterns', 'Step-by-step TOPIK I'], cta: 'topik.php' },
                        { name: 'TOPIK II Excellence', subType: 'LEVEL 3-6', category: 'advanced', icon: 'award', iconColor: 'rose-600', iconBg: 'rose-50', features: ['Academic & Professional', 'Advanced writing prep', 'News analysis'], cta: 'topik.php' }
                    ]
                }
            }
        };
        ...
        function renderModalPackages(packages) {
            ...
            body.innerHTML = packages.map(pkg => `
                <div class="relative group bg-white border ${pkg.highlight ? 'border-primary ring-1 ring-primary' : 'border-gray-100'} rounded-[24px] p-6 md:p-7 shadow-sm hover:shadow-xl transition-all duration-300 flex flex-col items-center text-center">
                    ${pkg.highlight ? `<div class="absolute -top-3.5 left-1/2 -translate-x-1/2 bg-primary text-white text-[10px] font-black px-3 py-1 rounded-full tracking-widest uppercase">${pkg.highlight}</div>` : ''}
                    <div class="w-12 h-12 rounded-2xl bg-${pkg.iconBg} flex items-center justify-center mb-5"><i data-lucide="${pkg.icon}" class="w-6 h-6 text-${pkg.iconColor}"></i></div>
            ...
            else if (packages.length === 2) { body.className = "grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto"; }
            else { body.className = "grid grid-cols-1 md:grid-cols-3 gap-8"; }
        }
