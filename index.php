        ...
        <div id="hero-carousel"
            ...
            <div id="carousel-slides" class="absolute inset-0 w-full h-full">
                ...
                <div class="slide absolute inset-0 w-full h-full opacity-100 transition-opacity duration-1000 z-10 cursor-pointer"
                    onclick="window.location.href='pages/neet.php'" data-index="0" style="background-color:#060d1c;">
                ...
                <div class="slide absolute inset-0 w-full h-full opacity-0 transition-opacity duration-1000 z-0 cursor-pointer"
                    onclick="window.location.href='pages/iit-jee.php'" data-index="1" style="background-color:#080c1a;">
                    <!-- Full-bleed banner image -->
                ...
                <!-- Slide 3 -->
                <div class="slide absolute inset-0 w-full h-full opacity-0 transition-opacity duration-1000 z-0 cursor-pointer"
                    onclick="window.location.href='pages/foundation1.php'" data-index="2"
                ...
                <!-- Slide 4 -->
                <div class="slide absolute inset-0 w-full h-full opacity-0 transition-opacity duration-1000 z-0 cursor-pointer"
                    onclick="window.location.href='pages/study-abroad.php'" data-index="3"
                    ...
                    <div
                        ...
                        <p
                            class="text-xs md:text-2xl font-bold text-blue-100 tracking-widest mb-1 uppercase opacity-90">
                            IELTS
                            | TOEFL | SAT / GRE</p>
                        <div class="flex flex-wrap items-center justify-center sm:justify-start gap-2 mb-8">
                            <span
                                ...
                                <span
                                    class="text-[10px] sm:text-sm md:text-base font-bold text-orange-200 tracking-wide uppercase">EXPERT
                ...
                <div class="slide absolute inset-0 w-full h-full opacity-0 transition-opacity duration-1000 z-0 cursor-pointer"
                    ...
                    style="background-color:#0a1628;">
                    <!-- Full-bleed banner image -->
                    <img src="assets/images/banner abroad.png" href="https://www.unidemy.com/" alt="Study Abroad"
                        class="absolute inset-0 w-full h-full object-cover object-center md:object-[80%]">
                    <!-- Mobile-optimized gradient -->
                    <div class="absolute inset-0 z-10 ">
                    </div>
    ...
    <div class="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
        <div class="text-center max-w-3xl mx-auto mt-16 md:mt-20 mb-12 md:mb-16 px-4">
            ...
            <p class="text-sm md:text-lg text-slate-600 leading-relaxed max-w-2xl mx-auto">
                From primary education to global university placements, discover the perfect pathway for your academic
                and career goals.
            </p>
        </div>
        ...
        <div id="programs-grid" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
            ...
            <div class="group relative rounded-2xl pt-10 pb-2 px-6 md:p-8 shadow-sm hover:shadow-2xl transition-all duration-500 border border-amber-100 flex flex-col h-[240px] md:h-[380px] overflow-hidden cursor-pointer"
                ...
                <div class="absolute inset-0 bg-gradient-to-t from-black/90 via-black/40 to-transparent rounded-3xl">
                </div>
                <div
                    class="absolute inset-0 bg-white/5 opacity-0 group-hover:opacity-100 transition-opacity rounded-3xl">
                </div>
                ...
                <div class="relative z-10 flex flex-col h-full justify-between">
                    ...
                    <div class="flex justify-between items-end mt-auto gap-4">
                        ...
                        <div
                            class="hidden w-10 h-10 rounded-xl bg-white/20 backdrop-blur-sm border border-white/30 flex items-center justify-center shrink-0 group-hover:bg-white transition-all duration-300 shadow-sm z-20">
                            <i data-lucide="arrow-up-right"
                                class="w-5 h-5 text-white group-hover:text-primary transition-colors"></i>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="relative z-10 flex flex-col h-full justify-between">
                    ...
                    <div class="flex justify-between items-end mt-auto gap-4">
                        <div class="flex flex-col gap-3">
                            ...
                            <div class="flex flex-wrap gap-2">
                                <span
                                    onclick="event.preventDefault(); window.location.href='pages/cbse.php?tab=class-1-5'"
                                ...
                                <span
                                    onclick="event.preventDefault(); window.location.href='pages/icse.php?tab=class-1-5'"
                                ...
                                <span
                                    ...
                                    class="bg-rose-400/20 backdrop-blur-sm text-xs font-semibold text-rose-50 px-3 py-1.5 rounded-full border border-rose-200/30 hover:bg-rose-500/40 cursor-pointer relative z-20 transition-all shadow-sm">Karnataka
                                    board</span>
                            </div>
                        </div>
                        <!-- DEVELOPER NOTE: Arrow button hidden by request -->
                ...
                <div class="relative z-10 flex flex-col h-full justify-between">
                    ...
                    <div class="flex justify-between items-end mt-auto gap-4">
                        <div class="flex flex-col gap-3">
                            ...
                            <div class="flex flex-wrap gap-2">
                                <span
                                    onclick="event.preventDefault(); window.location.href='pages/cbse.php?tab=class-6-8'"
                                ...
                                <span
                                    onclick="event.preventDefault(); window.location.href='pages/icse.php?tab=class-6-8'"
                                ...
                                <span
                                    ...
                                    class="bg-orange-400/20 backdrop-blur-sm text-xs font-semibold text-orange-50 px-3 py-1.5 rounded-full border border-orange-200/30 hover:bg-orange-500/40 cursor-pointer relative z-20 transition-all shadow-sm">Karnataka
                                    board</span>
                                <span onclick="event.preventDefault(); window.location.href='pages/foundation1.php'"
                                    class="bg-orange-400/20 backdrop-blur-sm text-xs font-semibold text-orange-50 px-3 py-1.5 rounded-full border border-orange-200/30 hover:bg-orange-500/40 cursor-pointer relative z-20 transition-all shadow-sm">Foundation
                                    1</span>
                            </div>
                        </div>
                        <!-- DEVELOPER NOTE: Arrow button hidden by request -->
                ...
                <div class="relative z-10 flex flex-col h-full justify-between">
                    ...
                    <div class="flex justify-between items-end mt-auto gap-4">
                        <div class="flex flex-col gap-3">
                            ...
                            <div class="flex flex-wrap gap-2">
                                <span
                                    onclick="event.preventDefault(); window.location.href='pages/cbse.php?tab=class-9-10'"
                                ...
                                <span
                                    onclick="event.preventDefault(); window.location.href='pages/icse.php?tab=class-9-10'"
                                ...
                                <span
                                    ...
                                    class="bg-green-400/20 backdrop-blur-sm text-xs font-semibold text-green-50 px-3 py-1.5 rounded-full border border-green-200/30 hover:bg-green-500/40 cursor-pointer relative z-20 transition-all shadow-sm">Karnataka
                                    board</span>
                                <span onclick="event.preventDefault(); window.location.href='pages/foundation2.php'"
                                    class="bg-green-400/20 backdrop-blur-sm text-xs font-semibold text-green-50 px-3 py-1.5 rounded-full border border-green-200/30 hover:bg-green-500/40 cursor-pointer relative z-20 transition-all shadow-sm">Foundation
                                    2</span>
                            </div>
                        </div>
                        <!-- DEVELOPER NOTE: Arrow button hidden by request -->
                        <div
                            class="hidden w-10 h-10 rounded-xl bg-white/20 backdrop-blur-sm border border-white/30 flex items-center justify-center shrink-0 group-hover:bg-white transition-all duration-300 shadow-sm z-20">
                            <i data-lucide="arrow-up-right"
                                class="w-5 h-5 text-white group-hover:text-green-600 transition-colors"></i>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="relative z-10 flex flex-col h-full justify-between">
                    ...
                    <div class="flex justify-between items-end mt-auto gap-4">
                        <div class="flex flex-col gap-3">
                            ...
                            <div class="flex flex-wrap gap-2">
                                <span
                                    onclick="event.preventDefault(); window.location.href='pages/career-achievers.php'"
                                    class="bg-rose-400/20 backdrop-blur-sm text-xs font-semibold text-rose-50 px-3 py-1.5 rounded-full border border-rose-200/30 hover:bg-rose-500/40 cursor-pointer relative z-20 transition-all shadow-sm">Class
                                    11</span>
                                <span
                                    onclick="event.preventDefault(); window.location.href='pages/career-achievers.php'"
                                    class="bg-rose-400/20 backdrop-blur-sm text-xs font-semibold text-rose-50 px-3 py-1.5 rounded-full border border-rose-200/30 hover:bg-rose-500/40 cursor-pointer relative z-20 transition-all shadow-sm">Class
                                    12</span>
                                <span
                                    onclick="event.preventDefault(); window.location.href='pages/career-achievers.php?tab=science#streams'"
                                ...
                                <span
                                    onclick="event.preventDefault(); window.location.href='pages/career-achievers.php?tab=economics#streams'"
                                ...
                                <span
                                    onclick="event.preventDefault(); window.location.href='pages/career-achievers.php?tab=commerce#streams'"
                        ...
                        <div class="flex flex-col gap-3">
                            ...
                            <div class="flex flex-wrap gap-2">
                                <span onclick="event.preventDefault(); window.location.href='pages/neet.php'"
                                    class="bg-blue-400/20 backdrop-blur-sm text-xs font-semibold text-blue-50 px-3 py-1.5 rounded-full border border-blue-200/30 hover:bg-blue-500/40 cursor-pointer relative z-20 transition-all shadow-sm">Class
                                    11</span>
                                <span onclick="event.preventDefault(); window.location.href='pages/neet.php'"
                                    class="bg-blue-400/20 backdrop-blur-sm text-xs font-semibold text-blue-50 px-3 py-1.5 rounded-full border border-blue-200/30 hover:bg-blue-500/40 cursor-pointer relative z-20 transition-all shadow-sm">Class
                                    12</span>
                        ...
                        <div class="flex flex-col gap-3">
                            ...
                            <div class="flex flex-wrap gap-2">
                                <span onclick="event.preventDefault(); window.location.href='pages/iit-jee.php'"
                                    class="bg-orange-400/20 backdrop-blur-sm text-xs font-semibold text-orange-50 px-3 py-1.5 rounded-full border border-orange-200/30 hover:bg-orange-500/40 cursor-pointer relative z-20 transition-all shadow-sm">Class
                                    11</span>
                                <span onclick="event.preventDefault(); window.location.href='pages/iit-jee.php'"
                                    class="bg-orange-400/20 backdrop-blur-sm text-xs font-semibold text-orange-50 px-3 py-1.5 rounded-full border border-orange-200/30 hover:bg-orange-500/40 cursor-pointer relative z-20 transition-all shadow-sm">Class
                                    12</span>
                        ...
                        <div class="flex flex-col gap-3">
                            ...
                            <div class="flex flex-wrap gap-2">
                                <span onclick="event.preventDefault(); window.location.href='pages/kcet.php'"
                                    class="bg-amber-400/20 backdrop-blur-sm text-[10px] md:text-xs font-semibold text-amber-50 px-2 py-1 md:px-3 md:py-1.5 rounded-full border border-amber-200/30 hover:bg-amber-500/40 cursor-pointer relative z-20 transition-all shadow-sm">Class
                                    11</span>
                                <span onclick="event.preventDefault(); window.location.href='pages/kcet.php'"
                                    class="bg-amber-400/20 backdrop-blur-sm text-[10px] md:text-xs font-semibold text-amber-50 px-2 py-1 md:px-3 md:py-1.5 rounded-full border border-amber-200/30 hover:bg-amber-500/40 cursor-pointer relative z-20 transition-all shadow-sm">Class
                                    12</span>
                        ...
                        <div class="flex flex-col gap-3">
                            ...
                            <div class="flex flex-wrap gap-2">
                                <span onclick="event.preventDefault(); window.location.href='pages/medical-abroad.php'"
                                    class="bg-indigo-400/20 backdrop-blur-sm text-xs font-semibold text-indigo-50 px-3 py-1.5 rounded-full border border-indigo-200/30 hover:bg-indigo-500/40 cursor-pointer relative z-20 transition-all shadow-sm">Medical
                                    abroad</span>
                                <span
                                    onclick="event.preventDefault(); window.location.href='pages/higher-education.php'"
                        ...
                        <div class="flex flex-col gap-3">
                            ...
                            <div class="flex flex-wrap gap-2">
                                <span
                                    ...
                                    class="bg-white/20 backdrop-blur-sm text-xs font-semibold text-white px-3 py-1.5 rounded-full border border-white/30 hover:bg-white/30 cursor-pointer relative z-20 transition-all shadow-sm">Artificial
                                    Intelligence</span>
                                <span
                                ...
                                <span
                                    ...
                                    class="bg-white/20 backdrop-blur-sm text-xs font-semibold text-white px-3 py-1.5 rounded-full border border-white/30 hover:bg-white/30 cursor-pointer relative z-20 transition-all shadow-sm">Web
...
<section id="testimonials" class="py-16 lg:py-20 bg-gradient-to-b from-white to-background relative overflow-hidden">
    ...
    <div class="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
        <div class="text-center max-w-3xl mx-auto mb-20 md:mb-24 px-4">
            ...
            <p class="text-sm md:text-lg text-slate-600 leading-relaxed">
                Don't just take our word for it. Hear what our successful students and alumni have to say about their
                journey.
            </p>
        </div>
    ...
    <div class="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
        <div class="text-center max-w-3xl mx-auto mb-12 md:mb-16 px-4">
            ...
            <h2 class="text-2xl sm:text-3xl md:text-5xl font-extrabold text-slate-900 mb-6 md:mb-8 tracking-tight">
                Premium <span class="text-transparent bg-clip-text bg-gradient-to-r from-primary to-blue-600">Study
                    Resources</span>
            </h2>
            <p class="text-sm md:text-lg text-slate-600 leading-relaxed">
    ...
    <div class="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
        <div class="text-center max-w-3xl mx-auto mb-12 md:mb-16 px-4">
            ...
            <p class="text-sm md:text-lg text-slate-600 leading-relaxed font-medium">
                Connect with millions of learners, get daily educational content, and never miss an important update
                from Unidemy Global.
            </p>
        </div>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div
            ...
            <div class="lg:w-1/2 mb-12 lg:mb-0 text-center lg:text-left">
                ...
                <h2
                    class="text-2xl sm:text-4xl lg:text-6xl font-black text-white mb-6 md:mb-8 leading-tight tracking-tight">
...
<div id="board-sheet-overlay"
    class="fixed inset-0 bg-slate-900/60 backdrop-blur-sm z-[200] hidden opacity-0 transition-opacity duration-300"
    onclick="toggleBoardSheet(false)">
    <div id="board-sheet"
        class="absolute bottom-0 left-0 right-0 bg-white rounded-t-[2.5rem] p-8 translate-y-full transition-transform duration-300 ease-out"
        ...
        <div class="grid grid-cols-1 gap-4">
            <a href="pages/kindergarten.php"
                class="flex items-center gap-4 p-5 rounded-2xl bg-slate-50 border border-slate-100 active:bg-slate-100 transition-all group">
                ...
                <i data-lucide="chevron-right"
                    class="w-5 h-5 text-slate-300 group-hover:translate-x-1 transition-transform"></i>
            </a>

            <a href="pages/cbse.php"
                class="flex items-center gap-4 p-5 rounded-2xl bg-slate-50 border border-slate-100 active:bg-slate-100 transition-all group">
                <div class="w-12 h-12 rounded-xl bg-white shadow-sm flex items-center justify-center">
            ...
            <a href="pages/karnataka-board.php"
                class="flex items-center gap-4 p-5 rounded-2xl bg-slate-50 border border-slate-100 active:bg-slate-100 transition-all group">
                <div class="w-12 h-12 rounded-xl bg-white shadow-sm flex items-center justify-center">
        ...
        <button onclick="toggleBoardSheet(false)"
            class="w-full mt-8 py-4 text-slate-400 font-bold text-sm uppercase tracking-widest">Cancel</button>
    </div>
</div>
