<?php
$pageTitle = 'Forgot Password | Unidemy Global';
$pageDescription = 'Reset your Unidemy Global account password.';
$base_url = '../';
    ...
    <div class="relative z-10 w-full max-w-lg px-6">
        ...
        <div class="bg-white/90 backdrop-blur-xl border border-white/40 rounded-[40px] shadow-2xl overflow-hidden p-8 md:p-10">
            ...
            <div class="text-center mb-10">
                ...
                <p class="text-gray-500 font-medium">No worries, we'll send you reset instructions.</p>
            </div>
            ...
            <div class="text-center">
                <a href="../auth/login.php" class="text-gray-600 font-bold hover:text-primary transition-colors inline-flex items-center gap-2 group">
