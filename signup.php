        ...
        <div class="bg-white/90 backdrop-blur-xl border border-white/40 rounded-[40px] shadow-2xl overflow-hidden p-8 md:p-10">
                ...
                <div class="flex flex-col md:flex-row md:items-center justify-between gap-6 pt-2">
                    <div class="flex items-start gap-3 max-w-sm">
                        ...
                        <label for="terms" class="text-xs font-bold text-gray-600 cursor-pointer select-none">
                            I agree to the <a href="terms.php" class="text-primary hover:text-blue-800 transition-colors">Terms</a> & <a href="privacy.php" class="text-primary hover:text-blue-800 transition-colors">Privacy</a>
                        </label>
                    </div>
            ...
            <div class="text-center">
                <p class="text-gray-600 font-medium text-sm">
                    ...
                    <a href="login.php" class="text-primary font-bold hover:text-blue-800 transition-colors inline-flex items-center gap-1 group">
                        Log in here
