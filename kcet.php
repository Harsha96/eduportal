    ...
    <div class="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6" id="cards-container">
            ...
            <div class="course-card bg-[#20252b] rounded-2xl overflow-hidden flex flex-col group shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-1 block"
                ...
                <div class="p-6 flex flex-col flex-grow text-white">
                    <div class="flex items-center justify-between mb-3">
                        <span class="text-[#FBBF24] font-semibold text-sm">Class 11 KCET</span>
                        <span
                    ...
                    <h3 class="text-[22px] font-bold mb-5 text-white">Pratham KCET</h3>
                    ...
                    <button onclick="toggleContent(this)"
                        class="flex items-center gap-2 text-[#FBBF24] font-bold text-sm mb-6 hover:gap-3 transition-all group/btn">
                        <span>Read More</span>
                    ...
                    <div class="mt-auto flex items-end justify-between pt-5 border-t border-gray-700/50">
                        ...
                        <div class="flex items-center gap-2">
                            <button onclick="openEnrollmentModal('KCET - Pratham KCET (Class 11)')"
            ...
            <div class="course-card bg-[#20252b] rounded-2xl overflow-hidden flex flex-col group shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-1 block"
                ...
                <div class="p-6 flex flex-col flex-grow text-white">
                    <div class="flex items-center justify-between mb-3">
                        <span class="text-[#FBBF24] font-semibold text-sm">Class 12 KCET</span>
                        <span
                            class="text-[10px] font-bold border border-gray-600/60 text-gray-300 px-2.5 py-1 rounded uppercase tracking-wide">HINGLISH</span>
                    </div>
                    <h3 class="text-[22px] font-bold mb-5 text-white">Pratham KCET</h3>
                    ...
                    <div class="mt-auto flex items-end justify-between pt-5 border-t border-gray-700/50">
                        ...
                        <div class="flex items-center gap-2">
                            <button onclick="openEnrollmentModal('KCET - Pratham KCET (Class 12)')"
                                class="bg-white text-gray-900 font-bold px-5 py-2.5 rounded-lg text-sm hover:bg-gray-100 transition-colors">Enroll
                                Request</button>
                            <button
                                class="border border-gray-600 bg-transparent text-white w-[42px] h-[42px] rounded-lg flex items-center justify-center hover:bg-gray-800 transition-colors">
            ...
            <div class="course-card bg-[#20252b] rounded-2xl overflow-hidden flex flex-col group shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-1 block"
                ...
                <div class="p-6 flex flex-col flex-grow text-white">
                    <div class="flex items-center justify-between mb-3">
                        <span class="text-[#FBBF24] font-semibold text-sm">Class 11 KCET</span>
                        <span
                            class="text-[10px] font-bold border border-gray-600/60 text-gray-300 px-2.5 py-1 rounded uppercase tracking-wide">Hindi</span>
                    </div>
                    <h3 class="text-[22px] font-bold mb-5 text-white">Lakshya KCET</h3>
                    ...
                    <div class="mt-auto flex items-end justify-between pt-5 border-t border-gray-700/50">
                        ...
                        <div class="flex items-center gap-2">
                            <button onclick="openEnrollmentModal('KCET - Lakshya KCET (Class 11)')"
                                class="bg-white text-gray-900 font-bold px-5 py-2.5 rounded-lg text-sm hover:bg-gray-100 transition-colors">Enroll
                                Request</button>
                            <button
                                class="border border-gray-600 bg-transparent text-white w-[42px] h-[42px] rounded-lg flex items-center justify-center hover:bg-gray-800 transition-colors">
            ...
            <div class="course-card bg-[#20252b] rounded-2xl overflow-hidden flex flex-col group shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-1 block"
                ...
                <div class="p-6 flex flex-col flex-grow text-white">
                    ...
                    <h3 class="text-[22px] font-bold mb-5 text-white">Arjuna KCET</h3>
                    ...
                    <div class="mt-auto flex items-end justify-between pt-5 border-t border-gray-700/50">
                        ...
                        <div class="flex items-center gap-2">
                            <button onclick="openEnrollmentModal('KCET - Arjuna KCET (Class 11)')"
                                class="bg-white text-gray-900 font-bold px-5 py-2.5 rounded-lg text-sm hover:bg-gray-100 transition-colors">Enroll
                                Request</button>
                            <button
                                class="border border-gray-600 bg-transparent text-white w-[42px] h-[42px] rounded-lg flex items-center justify-center hover:bg-gray-800 transition-colors">
            ...
            <div class="course-card bg-[#20252b] rounded-2xl overflow-hidden flex flex-col group shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-1 block"
                ...
                <div class="p-6 flex flex-col flex-grow text-white">
                    <div class="flex items-center justify-between mb-3">
                        <span class="text-[#FBBF24] font-semibold text-sm">Repeater KCET</span>
                        <span
                            class="text-[10px] font-bold border border-gray-600/60 text-gray-300 px-2.5 py-1 rounded uppercase tracking-wide">ENGLISH</span>
                    </div>
                    <h3 class="text-[22px] font-bold mb-5 text-white">Pinnacle KCET</h3>
                    ...
                    <div class="mt-auto flex items-end justify-between pt-5 border-t border-gray-700/50">
                        ...
                        <div class="flex items-center gap-2">
                            <button onclick="openEnrollmentModal('KCET - Pinnacle KCET (Repeater)')"
                                class="bg-white text-gray-900 font-bold px-5 py-2.5 rounded-lg text-sm hover:bg-gray-100 transition-colors">Enroll
                                Request</button>
                            <button
                                class="border border-gray-600 bg-transparent text-white w-[42px] h-[42px] rounded-lg flex items-center justify-center hover:bg-gray-800 transition-colors">
